...
interface DateUtilOld {
    ...
    fun dayNameString(format: String = "E"): String //fun dayNameString(format: String): String //changed because it broke the contract
    fun dayNameString(mills: Long, format: String = "E"): String //fun dayNameString(mills: Long, format: String): String //changed because it broke the contract
    fun dayString(): String = dayString(now())
    fun dayString(mills: Long): String
    fun monthString(format: String = "MMM"): String //fun monthString(format: String): String //changed because it broke the contract
    fun monthString(mills: Long, format: String = "MMM"): String //fun monthString(mills: Long, format: String): String //changed because it broke the contract
    ...
    fun dayAgo(time: Long, rh: ResourceHelper, round: Boolean = false): String //fun dayAgo(time: Long, rh: ResourceHelper, round: Boolean): String //changed because it broke the contract
    ...
    fun mergeHourMinuteToTimestamp(timestamp: Long, hour: Int, minute: Int, randomSecond: Boolean = false): Long // fun mergeHourMinuteToTimestamp(timestamp: Long, hour: Int, minute: Int, randomSecond: Boolean): Long //changed because it broke the contract
}
