...
class EventOverviewBolusProgress(status: String, val id: Long? = null, percent: Int? = null) : Event() {
     ...
     */
    constructor(rh: ResourceHelper, ch: ConcentrationHelper, delivered: PumpInsulin, id: Long? = null) :
        this(
            rh.gs(R.string.bolus_delivering, delivered.internationalUnits(ch.concentration)),
            id = id,
            percent = min((delivered.internationalUnits(ch.concentration) / BolusProgressData.insulin * 100).toInt(), 100)
        )
