...
enum class IntKey(
    ...
    OverviewCarbsButtonIncrement1(key = "carbs_button_increment_1", defaultValue = 5, min = -50, max = 50, titleResId = R.string.pref_title_carbs_button_increment_1, summaryResId = R.string.carb_increment_button_message, defaultedBySM = true, dependency = BooleanKey.OverviewShowCarbsButton),
    OverviewCarbsButtonIncrement2(key = "carbs_button_increment_2", defaultValue = 10, min = -50, max = 50, titleResId = R.string.pref_title_carbs_button_increment_2, summaryResId = R.string.carb_increment_button_message, defaultedBySM = true, dependency = BooleanKey.OverviewShowCarbsButton),
    OverviewCarbsButtonIncrement3(key = "carbs_button_increment_3", defaultValue = 20, min = -50, max = 50, titleResId = R.string.pref_title_carbs_button_increment_3, summaryResId = R.string.carb_increment_button_message, defaultedBySM = true, dependency = BooleanKey.OverviewShowCarbsButton),
    ...
    OverviewBolusPercentage(key = "boluswizard_percentage", defaultValue = 100, min = 10, max = 100, titleResId = R.string.pref_title_bolus_percentage, summaryResId = R.string.deliverpartofboluswizard),
    OverviewResetBolusPercentageTime(key = "key_reset_boluswizard_percentage_time", defaultValue = 16, min = 6, max = 120, titleResId = R.string.pref_title_reset_bolus_percentage_time, summaryResId = R.string.deliver_part_of_boluswizard_reset_time, defaultedBySM = true, engineeringModeOnly = true),
    ...
    LoopOpenModeMinChange(key = "loop_openmode_min_change", defaultValue = 30, min = 0, max = 50, titleResId = R.string.pref_title_open_mode_min_change, summaryResId = R.string.loop_open_mode_min_change_summary, defaultedBySM = true),
    ...
    ApsUamMaxMinutesOfBasalToLimitSmb(key = "uamsmbmaxminutes", defaultValue = 30, min = 15, max = 120, titleResId = R.string.pref_title_uam_smb_max_minutes, summaryResId = R.string.uam_smb_max_minutes, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    ApsCarbsRequestThreshold(key = "carbsReqThreshold", defaultValue = 1, min = 1, max = 100, titleResId = R.string.pref_title_carbs_request_threshold, summaryResId = R.string.carbs_req_threshold_summary, defaultedBySM = true),
    ApsAutoIsfHalfBasalExerciseTarget(key = "half_basal_exercise_target", defaultValue = 160, min = 120, max = 200, titleResId = R.string.pref_title_half_basal_exercise_target, summaryResId = R.string.half_basal_exercise_target_summary, defaultedBySM = true),
    ApsAutoIsfIobThPercent(key = "iob_threshold_percent", defaultValue = 100, min = 10, max = 100, titleResId = R.string.pref_title_iob_threshold_percent, summaryResId = R.string.openapsama_iob_threshold_percent_summary, defaultedBySM = true),
    ApsDynIsfAdjustmentFactor(key = "DynISFAdjust", defaultValue = 100, min = 1, max = 300, titleResId = R.string.pref_title_dynisf_adjustment_factor, summaryResId = R.string.dyn_isf_adjust_summary, dependency = BooleanKey.ApsUseDynamicSensitivity),
    AutosensPeriod(key = "openapsama_autosens_period", defaultValue = 24, min = 4, max = 24, titleResId = R.string.pref_title_autosens_period, summaryResId = R.string.openapsama_autosens_period_summary, calculatedDefaultValue = true),
    ...
    AutotuneDefaultTuneDays(key = "autotune_default_tune_days", defaultValue = 5, min = 1, max = 30, titleResId = R.string.pref_title_autotune_days, summaryResId = R.string.autotune_default_tune_days_summary),
