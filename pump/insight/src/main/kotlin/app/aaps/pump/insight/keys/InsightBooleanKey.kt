...
enum class InsightBooleanKey(
    ...
    EnableTbrEmulation("insight_enable_tbr_emulation", false, titleResId = R.string.enable_tbr_emulation),
    DisableVibration("insight_disable_vibration", false, titleResId = R.string.disable_vibration),
    DisableVibrationAuto("insight_disable_vibration_auto", false, titleResId = R.string.disable_vibration_auto),
}
