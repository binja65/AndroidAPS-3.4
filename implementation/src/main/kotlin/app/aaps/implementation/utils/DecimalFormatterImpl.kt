...
class DecimalFormatterImpl @Inject constructor(
    ...
    override fun toPumpSupportedBolusWithConcentratedUnits(value: Double, bolusStep: Double): String =
        if (bolusStep <= 0.051) rh.gs(R.string.pump_insulin_cu, value) else rh.gs(R.string.pump_insulin_cu1, value)
